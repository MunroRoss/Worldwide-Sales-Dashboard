...
This dashboard is built using pre-existing Superstore Data gathered from [Kaggle]([https://pages.github.com/](https://www.kaggle.com/datasets/apoorvaappz/global-super-store-dataset)) and covers the years of 2011-2014
##Dashboard Overview
